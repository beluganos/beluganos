...
_NEIGH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='n_id', full_name='nlaapi.Neigh.n_id', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ne_id', full_name='nlaapi.Neigh.ne_id', index=8,
