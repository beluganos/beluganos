...
class RIBSApiStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetNexthopMap = channel.unary_stream(
        ...
        request_serializer=ribsapi__pb2.GetNexthopMapRequest.SerializeToString,
        response_deserializer=ribsapi__pb2.NexthopMap.FromString,
        )
...
def add_RIBSApiServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetNexthopMap': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=ribsapi__pb2.GetNexthopMapRequest.FromString,
          response_serializer=ribsapi__pb2.NexthopMap.SerializeToString,
      ),
  }
