...
FFPacketRequest = _reflection.GeneratedProtocolMessageType('FFPacketRequest', (_message.Message,), {
...
SendFFPacketReply = _reflection.GeneratedProtocolMessageType('SendFFPacketReply', (_message.Message,), {
