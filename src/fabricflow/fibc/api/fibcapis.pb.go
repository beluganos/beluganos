...
func (DbDpEntry_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5600d3affcc40088, []int{39, 0}
}
...
type VmMonitorReply_Oam struct {
	Oam *OAMRequest `protobuf:"bytes,4,opt,name=oam,proto3,oneof"`
}
...
func (*VmMonitorReply_Oam) isVmMonitorReply_Body() {}
...
func (m *VmMonitorReply) GetOam() *OAMRequest {
	if x, ok := m.GetBody().(*VmMonitorReply_Oam); ok {
		return x.Oam
	}
	return nil
}
...
type VsMonitorReply_Oam struct {
	Oam *OAMRequest `protobuf:"bytes,3,opt,name=oam,proto3,oneof"`
}
...
func (*VsMonitorReply_Oam) isVsMonitorReply_Body() {}
...
func (m *VsMonitorReply) GetOam() *OAMRequest {
	if x, ok := m.GetBody().(*VsMonitorReply_Oam); ok {
		return x.Oam
	}
	return nil
}
...
type DpMonitorReply_Oam struct {
	Oam *OAMRequest `protobuf:"bytes,6,opt,name=oam,proto3,oneof"`
}
...
func (*DpMonitorReply_Oam) isDpMonitorReply_Body() {}
...
func (m *DpMonitorReply) GetOam() *OAMRequest {
	if x, ok := m.GetBody().(*DpMonitorReply_Oam); ok {
		return x.Oam
	}
	return nil
}
...
type OAMRequest struct {
	Xid                  uint32       `protobuf:"varint,1,opt,name=xid,proto3" json:"xid,omitempty"`
	Request              *OAM_Request `protobuf:"bytes,2,opt,name=request,proto3" json:"request,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}

func (m *OAMRequest) Reset()         { *m = OAMRequest{} }
func (m *OAMRequest) String() string { return proto.CompactTextString(m) }
func (*OAMRequest) ProtoMessage()    {}
func (*OAMRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5600d3affcc40088, []int{32}
}

func (m *OAMRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OAMRequest.Unmarshal(m, b)
}
func (m *OAMRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OAMRequest.Marshal(b, m, deterministic)
}
func (m *OAMRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OAMRequest.Merge(m, src)
}
func (m *OAMRequest) XXX_Size() int {
	return xxx_messageInfo_OAMRequest.Size(m)
}
func (m *OAMRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_OAMRequest.DiscardUnknown(m)
}

var xxx_messageInfo_OAMRequest proto.InternalMessageInfo

func (m *OAMRequest) GetXid() uint32 {
	if m != nil {
		return m.Xid
	}
	return 0
...
func (m *OAMRequest) GetRequest() *OAM_Request {
	if m != nil {
		return m.Request
	}
	return nil
...
type OAMReply struct {
	Xid                  uint32     `protobuf:"varint,1,opt,name=xid,proto3" json:"xid,omitempty"`
	Reply                *OAM_Reply `protobuf:"bytes,2,opt,name=reply,proto3" json:"reply,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}

func (m *OAMReply) Reset()         { *m = OAMReply{} }
func (m *OAMReply) String() string { return proto.CompactTextString(m) }
func (*OAMReply) ProtoMessage()    {}
func (*OAMReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_5600d3affcc40088, []int{33}
}

func (m *OAMReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OAMReply.Unmarshal(m, b)
}
func (m *OAMReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OAMReply.Marshal(b, m, deterministic)
}
func (m *OAMReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OAMReply.Merge(m, src)
}
func (m *OAMReply) XXX_Size() int {
	return xxx_messageInfo_OAMReply.Size(m)
}
func (m *OAMReply) XXX_DiscardUnknown() {
	xxx_messageInfo_OAMReply.DiscardUnknown(m)
}

var xxx_messageInfo_OAMReply proto.InternalMessageInfo

func (m *OAMReply) GetXid() uint32 {
	if m != nil {
		return m.Xid
	}
	return 0
...
func (m *OAMReply) GetReply() *OAM_Reply {
	if m != nil {
		return m.Reply
	}
	return nil
...
type OAMReplyAck struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *OAMReplyAck) Reset()         { *m = OAMReplyAck{} }
func (m *OAMReplyAck) String() string { return proto.CompactTextString(m) }
func (*OAMReplyAck) ProtoMessage()    {}
func (*OAMReplyAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_5600d3affcc40088, []int{34}
}

func (m *OAMReplyAck) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OAMReplyAck.Unmarshal(m, b)
}
func (m *OAMReplyAck) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OAMReplyAck.Marshal(b, m, deterministic)
}
func (m *OAMReplyAck) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OAMReplyAck.Merge(m, src)
}
func (m *OAMReplyAck) XXX_Size() int {
	return xxx_messageInfo_OAMReplyAck.Size(m)
}
func (m *OAMReplyAck) XXX_DiscardUnknown() {
	xxx_messageInfo_OAMReplyAck.DiscardUnknown(m)
}

var xxx_messageInfo_OAMReplyAck proto.InternalMessageInfo
...
func (*DbDpEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_5600d3affcc40088, []int{39}
}
...
func (*StatsEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_5600d3affcc40088, []int{40}
}
...
func (*ApGetStatsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5600d3affcc40088, []int{41}
}
...
func init() {
	...
	proto.RegisterType((*OAMRequest)(nil), "fibcapi.OAMRequest")
	proto.RegisterType((*OAMReply)(nil), "fibcapi.OAMReply")
	proto.RegisterType((*OAMReplyAck)(nil), "fibcapi.OAMReplyAck")
...
var fileDescriptor_5600d3affcc40088 = []byte{
	...
	,
}
...
type FIBCApApiClient interface {
	...
	RunOAM(ctx context.Context, in *OAM_Request, opts ...grpc.CallOption) (*OAMReplyAck, error)
}
...
func (c *fIBCApApiClient) RunOAM(ctx context.Context, in *OAM_Request, opts ...grpc.CallOption) (*OAMReplyAck, error) {
	out := new(OAMReplyAck)
	err := c.cc.Invoke(ctx, "/fibcapi.FIBCApApi/RunOAM", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FIBCApApiServer interface {
	...
	RunOAM(context.Context, *OAM_Request) (*OAMReplyAck, error)
}
...
func (*UnimplementedFIBCApApiServer) RunOAM(ctx context.Context, req *OAM_Request) (*OAMReplyAck, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RunOAM not implemented")
}
...
func _FIBCApApi_RunOAM_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OAM_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FIBCApApiServer).RunOAM(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibcapi.FIBCApApi/RunOAM",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FIBCApApiServer).RunOAM(ctx, req.(*OAM_Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FIBCApApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RunOAM",
			Handler:    _FIBCApApi_RunOAM_Handler,
		},
	},
...
type FIBCVmApiClient interface {
	...
	SendOAMReply(ctx context.Context, in *OAMReply, opts ...grpc.CallOption) (*OAMReplyAck, error)
...
func (c *fIBCVmApiClient) SendOAMReply(ctx context.Context, in *OAMReply, opts ...grpc.CallOption) (*OAMReplyAck, error) {
	out := new(OAMReplyAck)
	err := c.cc.Invoke(ctx, "/fibcapi.FIBCVmApi/SendOAMReply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FIBCVmApiServer interface {
	...
	SendOAMReply(context.Context, *OAMReply) (*OAMReplyAck, error)
...
func (*UnimplementedFIBCVmApiServer) SendOAMReply(ctx context.Context, req *OAMReply) (*OAMReplyAck, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendOAMReply not implemented")
}
...
func _FIBCVmApi_SendOAMReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OAMReply)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FIBCVmApiServer).SendOAMReply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibcapi.FIBCVmApi/SendOAMReply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FIBCVmApiServer).SendOAMReply(ctx, req.(*OAMReply))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FIBCVmApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendOAMReply",
			Handler:    _FIBCVmApi_SendOAMReply_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
...
func (c *fIBCVsApiClient) SendOAMReply(ctx context.Context, in *OAMReply, opts ...grpc.CallOption) (*OAMReplyAck, error) {
	out := new(OAMReplyAck)
	err := c.cc.Invoke(ctx, "/fibcapi.FIBCVsApi/SendOAMReply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedFIBCVsApiServer) SendOAMReply(ctx context.Context, req *OAMReply) (*OAMReplyAck, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendOAMReply not implemented")
}
...
func _FIBCVsApi_SendOAMReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OAMReply)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FIBCVsApiServer).SendOAMReply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibcapi.FIBCVsApi/SendOAMReply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FIBCVsApiServer).SendOAMReply(ctx, req.(*OAMReply))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FIBCVsApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendOAMReply",
			Handler:    _FIBCVsApi_SendOAMReply_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
...
func (c *fIBCDpApiClient) SendOAMReply(ctx context.Context, in *OAMReply, opts ...grpc.CallOption) (*OAMReplyAck, error) {
	out := new(OAMReplyAck)
	err := c.cc.Invoke(ctx, "/fibcapi.FIBCDpApi/SendOAMReply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedFIBCDpApiServer) SendOAMReply(ctx context.Context, req *OAMReply) (*OAMReplyAck, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendOAMReply not implemented")
}
...
func _FIBCDpApi_SendOAMReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OAMReply)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FIBCDpApiServer).SendOAMReply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fibcapi.FIBCDpApi/SendOAMReply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FIBCDpApiServer).SendOAMReply(ctx, req.(*OAMReply))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FIBCDpApi_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendOAMReply",
			Handler:    _FIBCDpApi_SendOAMReply_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
